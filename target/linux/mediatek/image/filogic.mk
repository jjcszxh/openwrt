...
define Device/beeconmini_seed-ac1
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -wpad-basic-mbedtls kmod-i2c-gpio kmod-sfp kmod-usb3 kmod-fs-f2fs mkf2fs kmod-fs-ext4  e2fsprogs kmod-mt7981-firmware mt7981-wo-firmware
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
